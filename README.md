...
```
npm create cloudflare@latest -- --template=cloudflare/templates/broad-sun-88bc
```

A live public deployment of this template is available at [https://broad-sun-88bc.templates.workers.dev](https://broad-sun-88bc.templates.workers.dev)
